        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8">A description list is perfect for defining terms.</dt>
                    <dt class="col-sm-4">Term</dt>
                    <dd class="col-sm-8">Definition for the term.</dt>
                    <dt class="col-sm-4">Another term</dt>
                    <dd class="col-sm-8">This definition is short, so no extra paragraphs or anything.</dt>
